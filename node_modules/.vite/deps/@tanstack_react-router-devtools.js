...
import { nt as useRouter, s as useRouterState } from "./index.dev-VE_oQg0d.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-CnpwH7La-DHNoJEec.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-SWyE65Is-B90CVVc3.js"));
